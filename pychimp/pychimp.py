...
class PyChimp(object):
    ...
    def campaignTemplates(self):
        ...
        '''
        return self.callServer("campaignTemplates")
    ...
    def campaignFolders(self):
        ...
        '''
        return self.callServer("campaignFolders")
    ...
    def campaignBounceMessages(self, cid, start=0, limit=25, since=None):
        '''
    ...
    def campaignOpenedAIM(self, cid, start=0, limit=1000):
        '''
    ...
    def listInterestGroupAdd(self, id, group_name):
        '''
